...
/**
 * Golden corpus: fixtures/corpus.jsonl, 263 messages: 174 Saudi from the spike, 89 Egyptian (CIB English, NBE Arabic) from public parser test suites.
...
class CorpusTest {
    ...
    @Test
    fun corpusIsNotEmpty() = assertTrue(rows.size >= 263, "expected the full corpus, got ${rows.size}")
